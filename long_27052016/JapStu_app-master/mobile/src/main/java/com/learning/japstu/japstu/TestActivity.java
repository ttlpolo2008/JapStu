...
public class TestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      ((Button)findViewById(R.id.btn_show_result)).setVisibility(View.GONE);
      // set title
      title = getResources()
      ...
      findViewById(R.id.question_field_1).setVisibility(View.GONE);  // off view of other question
      findViewById(R.id.question_field_2).setVisibility(View.GONE);
      findViewById(R.id.question_field_3).setVisibility(View.GONE);
      new TestLoadingAsyncTask().execute();

    }

  private class TestLoadingAsyncTask extends AsyncTask<String, Void, Void> {
    ...
    protected Void doInBackground(String... params) {
      try {
        exercise = new Exercise(sLessonID, true);
