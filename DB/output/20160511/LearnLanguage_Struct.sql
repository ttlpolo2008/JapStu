...
CREATE TABLE `t_learn_1` (
  ...
  `EXAM_MARK` int(5) DEFAULT NULL,
  PRIMARY KEY (`LEARN_ID`),
  KEY `T_LEARN_1-T_LESSON_COURSE` (`LESSON_ID`),
  CONSTRAINT `T_LEARN_1-T_LESSON_COURSE` FOREIGN KEY (`LESSON_ID`) REFERENCES `t_lesson` (`LESSON_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_learn_2` (
  `LEARN_ID` int(11) NOT NULL AUTO_INCREMENT,
  `LESSON_ID` int(11) NOT NULL,
  `START_DATE` date DEFAULT NULL,
  `END_DATE` date DEFAULT NULL,
  ...
  `EXAM_MARK` int(5) DEFAULT NULL,
  PRIMARY KEY (`LEARN_ID`),
  KEY `T_LEARN_2-T_LESSON_COURSE` (`LESSON_ID`),
  CONSTRAINT `T_LEARN_2-T_LESSON_COURSE` FOREIGN KEY (`LESSON_ID`) REFERENCES `t_lesson` (`LESSON_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
