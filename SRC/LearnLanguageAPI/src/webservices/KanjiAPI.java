...
public class KanjiAPI {
	...
	@POST
	@Path("/searchKanji.json")
	@Produces(MediaType.APPLICATION_JSON)
	public String searchKanji(String requestBody) {
		...
		try {
			...
			if (!body.has("lessonId")) {
				...
				// Search Kanji
				List<KanjiDto> kanjiDtoList = KanjiService.searchKanji(lessonId);
				Gson gson = new Gson();
				String jsonData = gson.toJson(kanjiDtoList);
