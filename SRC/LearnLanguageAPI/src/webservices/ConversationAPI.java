...
@Path("ConversationAPI")
public class ConversationAPI {

	@POST
	@Path("/searchConversation.json")
	@Produces(MediaType.APPLICATION_JSON)
	public String searchConversation(String requestBody) {
		...
		try {
			...
			if (!body.has("lessonId")) {
				...
				// Search Conversation
				List<ConversationDto> conversationDtoList = ConversationService.searchConversation(lessonId);
				Gson gson = new Gson();
				String jsonData = gson.toJson(conversationDtoList);
